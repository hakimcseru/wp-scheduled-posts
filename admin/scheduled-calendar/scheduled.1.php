...
class wpsp_scheduled {
    ...
    function edcal_list_admin() {
        ...
        <!-- hakim code start here -->
        <?php
        echo '<script type="text/javascript">';
        $this->edcal_echoFile(dirname( __FILE__ ) . "/codebase/dhtmlxscheduler.js");
        echo '</script>';?>
        <?php echo '<style type="text/css">';
        $this->edcal_echoFile(dirname( __FILE__ ) . "/codebase/dhtmlxscheduler_material.css");
        echo '</style>';?>
                <?php
        echo '<script type="text/javascript">';
        $this->edcal_echoFile(dirname( __FILE__ ) . "/codebase/ext/dhtmlxscheduler_minical.js");
        echo '</script>';?>
